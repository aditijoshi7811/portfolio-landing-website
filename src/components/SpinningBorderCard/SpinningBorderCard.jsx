...
const SpinningBorderCard = ({ title, description, avatarUrl }) => {
  return (
    <div className="relative p-1 bg-[#1f1f2a] rounded-xl shadow-lg border border-[#3b3b4d] overflow-hidden max-w-2xl mx-auto profile-card-border-glow">

      {/* Content wrapper to ensure z-index */}
      <div className="relative z-10 flex items-center p-5 bg-[#1f1f2a] rounded-xl">
